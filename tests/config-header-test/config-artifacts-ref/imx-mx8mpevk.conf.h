...
#define CFG_DDR_SIZE UL(0x180000000)
...
#define CFG_SHMEM_START ((0x40000000 - 0x01e00000 - 0x00200000 + UL(0x180000000)) + 0x01e00000)
...
#define CFG_TZDRAM_START (0x40000000 - 0x01e00000 - 0x00200000 + UL(0x180000000))
...
#define PLATFORM_FLAVOR mx8mpevk
#define PLATFORM_FLAVOR_mx8mpevk 1
