...
#define CFG_KERN_LINKER_ARCH riscv
#define CFG_KERN_LINKER_FORMAT elf64-littleriscv
...
/* CFG_PAN is not set */
#define CFG_PGT_CACHE_ENTRIES 4
...
/* CFG_RISCV_APLIC is not set */
/* CFG_RISCV_APLIC_MSI is not set */
#define CFG_RISCV_FPU 1
/* CFG_RISCV_IMSIC is not set */
#define CFG_RISCV_ISA_C 1
#define CFG_RISCV_MMU_MODE 39
#define CFG_RISCV_MTIME_RATE 10000000
/* CFG_RISCV_M_MODE is not set */
#define CFG_RISCV_PLIC 1
#define CFG_RISCV_SBI 1
/* CFG_RISCV_SBI_CONSOLE is not set */
#define CFG_RISCV_SBI_MPXY 1
#define CFG_RISCV_SBI_MPXY_RPMI 1
#define CFG_RISCV_S_MODE 1
#define CFG_RISCV_TIME_SOURCE_RDTIME 1
#define CFG_RISCV_WITH_M_MODE_SM 1
#define CFG_RISCV_ZKR_RNG 1
/* CFG_RPMB_FS is not set */
/* CFG_RSA_PUB_EXPONENT_3 is not set */
/* CFG_RTC_PTA is not set */
#define CFG_RV64_core 1
#define CFG_RV64_ldelf 1
#define CFG_RV64_ta_rv64 1
...
#define CFG_TDDRAM_SIZE 0x00f00000
#define CFG_TDDRAM_START 0x8e000000
...
/* _CFG_CORE_LTC_OPTEE_THREAD is not set */
