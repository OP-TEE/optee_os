...
#define CFG_RISCV_MTIME_RATE 1000000
/* CFG_RISCV_M_MODE is not set */
/* CFG_RISCV_PLIC is not set */
...
#define CFG_TDDRAM_SIZE 0x01000000
#define CFG_TDDRAM_START 0xF1000000
