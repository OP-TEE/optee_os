...
#define CFG_CORE_ARM64_PA_BITS 43
...
#define CFG_CORE_IRQ_IS_NATIVE_INTR 1
...
#define CFG_CRYPTO_DRV_ACIPHER 1
#define CFG_CRYPTO_DRV_AUTHENC 1
#define CFG_CRYPTO_DRV_ECC 1
#define CFG_CRYPTO_DRV_RSA 1
...
#define CFG_TZDRAM_START 0x60000000
...
#define CFG_VERSAL_CRYPTO_DRIVER 1
#define CFG_VERSAL_GPIO 1
#define CFG_VERSAL_HUK 1
#define CFG_VERSAL_HUK_KEY 12
#define CFG_VERSAL_MBOX 1
#define CFG_VERSAL_MBOX_IPI_ID 3
#define CFG_VERSAL_NVM 1
#define CFG_VERSAL_PM 1
#define CFG_VERSAL_PUF 1
#define CFG_VERSAL_RNG_DRV 1
#define CFG_VERSAL_SHA3_384 1
/* CFG_VERSAL_TRACE_MBOX is not set */
/* CFG_VERSAL_TRACE_PLM is not set */
#define CFG_VERSAL_TRNG_DF_MUL 2
#define CFG_VERSAL_TRNG_SEED_LIFE 3
...
#define PLATFORM_FLAVOR generic
#define PLATFORM_FLAVOR_generic 1
#define PLATFORM_versal 1
#define _CFG_ARM_V3_OR_V4 1
