...
#define CFG_UART_CLK_HZ UART0_CLK_IN_HZ
#define CFG_UART_IT IT_UART0
...
/* CFG_ZYNQMP_HUK_AES_EFUSE is not set */
#define CFG_ZYNQMP_HUK_USER_EFUSE_MASK 0
/* CFG_ZYNQMP_PM is not set */
#define PLATFORM_FLAVOR zcu102
#define PLATFORM_FLAVOR_zcu102 1
