...
/* CFG_PAN is not set */
#define CFG_PGT_CACHE_ENTRIES (18 * 2)
...
#define CFG_TEE_CORE_NB_CORE 18
...
#define PLATFORM_FLAVOR cnf10ka
#define PLATFORM_FLAVOR_cnf10ka 1
