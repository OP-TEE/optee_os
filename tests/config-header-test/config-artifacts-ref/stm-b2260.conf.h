...
#define CFG_SHMEM_START ((0x7e000000) + (0x01e00000 - 0x00200000))
...
#define CFG_STM_RSV_DRAM_STARTBYTES 0
...
#define CFG_TZDRAM_SIZE (0x01e00000 - 0x00200000)
#define CFG_TZDRAM_START (0x7e000000)
#define CFG_TZSRAM_SIZE (458752)
#define CFG_TZSRAM_START (0x7fe00000)
...
#define PLATFORM_FLAVOR b2260
#define PLATFORM_FLAVOR_b2260 1
