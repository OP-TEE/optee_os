...
#define CFG_DRAM_BASE UL(0x60000000)
...
/* CFG_IMX_CSU is not set */
#define CFG_IMX_DIGPROG 1
#define CFG_IMX_LPUART 1
...
#define CFG_NS_ENTRY_ADDR 0x60800000
...
#define CFG_SHMEM_START ((UL(0x60000000) - 0x01e00000 - 0x00200000 + 0x40000000) + 0x01e00000)
...
/* CFG_TZC380 is not set */
#define CFG_TZDRAM_SIZE 0x01e00000
#define CFG_TZDRAM_START (UL(0x60000000) - 0x01e00000 - 0x00200000 + 0x40000000)
...
#define PLATFORM_FLAVOR mx7ulpevk
#define PLATFORM_FLAVOR_mx7ulpevk 1
