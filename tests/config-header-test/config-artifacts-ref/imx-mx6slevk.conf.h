...
#define CFG_SHMEM_START ((0x80000000 - 0x01e00000 - 0x00200000 + 0x40000000) + 0x01e00000)
...
#define CFG_TZDRAM_START (0x80000000 - 0x01e00000 - 0x00200000 + 0x40000000)
...
#define PLATFORM_FLAVOR mx6slevk
#define PLATFORM_FLAVOR_mx6slevk 1
