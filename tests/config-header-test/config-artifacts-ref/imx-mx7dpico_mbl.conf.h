...
#define CFG_DDR_SIZE 0x20000000
...
#define CFG_EXTERNAL_DTB_OVERLAY 1
...
#define CFG_IMX_WDOG_EXT_RESET 1
...
#define CFG_NS_ENTRY_ADDR 0x87800000
...
#define CFG_SHMEM_START ((0x80000000 - 0x01e00000 - 0x00200000 + 0x20000000) + 0x01e00000)
...
#define CFG_TZDRAM_START (0x80000000 - 0x01e00000 - 0x00200000 + 0x20000000)
#define CFG_UART_BASE UART5_BASE
...
#define PLATFORM_FLAVOR mx7dpico_mbl
#define PLATFORM_FLAVOR_mx7dpico_mbl 1
