...
#define CFG_CLUSTERS_PER_NODE 6
...
/* CFG_PAN is not set */
#define CFG_PGT_CACHE_ENTRIES (36 * 2)
...
#define CFG_TEE_CORE_NB_CORE 36
...
#define PLATFORM_FLAVOR otx2t98
#define PLATFORM_FLAVOR_otx2t98 1
