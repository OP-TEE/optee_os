...
#define CFG_NO_SMP 1
#define CFG_NS_ENTRY_ADDR 0x80800000
...
#define CFG_SHMEM_START ((0x80000000 - 0x01e00000 - 0x00200000 + 0x80000000) + 0x01e00000)
...
#define CFG_TZDRAM_START (0x80000000 - 0x01e00000 - 0x00200000 + 0x80000000)
...
#define PLATFORM_FLAVOR mx6sllevk
#define PLATFORM_FLAVOR_mx6sllevk 1
