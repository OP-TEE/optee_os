...
#define CFG_SHMEM_START ((0x93a00000) + (0x01000000 - 0x00200000))
...
#define CFG_STIH_UART 1
#define CFG_STM_RSV_DRAM_STARTBYTES 0x02000000
...
#define CFG_TZDRAM_SIZE (0x01000000 - 0x00200000)
#define CFG_TZDRAM_START (0x93a00000)
#define CFG_TZSRAM_SIZE (458752)
#define CFG_TZSRAM_START (0x94a00000)
...
#define PLATFORM_FLAVOR cannes
#define PLATFORM_FLAVOR_cannes 1
