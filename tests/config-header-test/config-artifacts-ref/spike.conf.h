...
/* CFG_DEBUG_INFO is not set */
/* CFG_DEVICE_ENUM_PTA is not set */
...
#define CFG_RISCV_M_MODE 1
/* CFG_RISCV_SBI is not set */
...
#define CFG_TDDRAM_START 0xbdb00000
...
/* CFG_TEE_CORE_TA_TRACE is not set */
