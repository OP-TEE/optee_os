...
#ifndef OPTEE_TEE_API_PSA_TYPES_H
#define OPTEE_TEE_API_PSA_TYPES_H
...
static inline psa_status_t psa_set_key_domain_parameters(psa_key_attributes_t *attributes,
                                           psa_key_type_t type,
                                           const uint8_t *data,
                                           size_t data_length);
 ...
 */
typedef struct mbedtls_cipher_context_t mbedtls_cipher_context;


typedef struct  mbedtls_psa_cipher_operation_t mbedtls_psa_cipher_operation;
typedef struct psa_aead_operation_t psa_aead_operation;
#define MBEDTLS_PSA_CIPHER_OPERATION_INIT { 0, 0, 0, { 0 } }

#endif //OPTEE_TEE_API_PSA_TYPES_H
