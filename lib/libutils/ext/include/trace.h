...
void trace_color_printf(const char *fmt, ...) __attribute__ ((format (printf, 1, 2)));
void __attribute__((format(printf, 1, 0))) trace_color_vprintf(const char *fmt, va_list ap);

#define trace_color_printf_helper(...) trace_color_printf(__VA_ARGS__)
...
#define MSG_COLOR(...)   trace_color_printf(__VA_ARGS__)
