...
/*
 * Return true if the curve is a standard normal curve, a.k.a
 * Weierstrass normal curves, as the NIST curves, and is supported.
 */
static bool tee_curve_is_ec_standard_normal(uint32_t tee_id)
{
	switch (tee_id) {
				...
				struct obj_attrs **priv_head)
{
	...
	if (!tee_curve_is_ec_standard_normal(tee_curve))
		return PKCS11_CKR_CURVE_NOT_SUPPORTED;
