		   ...
		   struct pkcs11_object *obj)
{
	static const struct {
		...
		{ PKCS11_CKM_SHA512_RSA_PKCS_PSS,
 		...
 		{ PKCS11_CKM_ECDSA, TEE_ALG_ECDSA_SHA256, TEE_ALG_SHA256},
 		{ PKCS11_CKM_ECDSA_SHA1, TEE_ALG_ECDSA_SHA1, TEE_ALG_SHA1 },
 		{ PKCS11_CKM_ECDSA_SHA224, TEE_ALG_ECDSA_SHA224, TEE_ALG_SHA224 },
 		{ PKCS11_CKM_ECDSA_SHA256, TEE_ALG_ECDSA_SHA256, TEE_ALG_SHA256 },
 		{ PKCS11_CKM_ECDSA_SHA384, TEE_ALG_ECDSA_SHA384, TEE_ALG_SHA384 },
 		{ PKCS11_CKM_ECDSA_SHA512, TEE_ALG_ECDSA_SHA512, TEE_ALG_SHA512 },
#else
