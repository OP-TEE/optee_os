				      ...
				      struct pkcs11_object *obj)
{
	...
	case PKCS11_CKO_PRIVATE_KEY:
		...
		/*
		 * If the pre-computed CTR parameters are present load them
		...
		/*
		 * As mentioned above, if any of these optional attribute is
		 * missing, keep only the 3 first already loaded above.
		 */
		if (count != 8)
			count = 3;
