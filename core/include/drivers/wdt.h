 ...
 *
 * @is_started: pointer filled with true if the watchdog has started
 * @timeleft: pointer filled with the time left (in seconds) before the
 * watchdog timeouts, if the watchdog is started
