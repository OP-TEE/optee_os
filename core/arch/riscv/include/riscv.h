...
#define CSR_XSTATUS_FS		CSR_XSTATUS_FS_MASK

#define CSR_XSTATUS_FS_OFF	0
#define CSR_XSTATUS_FS_INITIAL	SHIFT_U64(1, CSR_XSTATUS_FS_BIT)
#define CSR_XSTATUS_FS_CLEAN	SHIFT_U64(2, CSR_XSTATUS_FS_BIT)
#define CSR_XSTATUS_FS_DIRTY	SHIFT_U64(3, CSR_XSTATUS_FS_BIT)
...
#define RISCV_FP_NUM_REGS	32
#define RISCV_FP_FCSR_OFF	(RISCV_FP_NUM_REGS * RISCV_FP_REG_BYTES)
