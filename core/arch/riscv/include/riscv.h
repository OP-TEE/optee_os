...
#define CSR_XSTATUS_VS_BIT	9
#define CSR_XSTATUS_VS_MASK	SHIFT_U64(3, CSR_XSTATUS_VS_BIT)/* 0x0600 */
#define CSR_XSTATUS_VS_OFF	SHIFT_U32(0, CSR_XSTATUS_VS_BIT)  /* 0x0000 */
#define CSR_XSTATUS_VS_INITIAL	SHIFT_U32(1, CSR_XSTATUS_VS_BIT)  /* 0x0200 */
#define CSR_XSTATUS_VS_CLEAN	SHIFT_U32(2, CSR_XSTATUS_VS_BIT)  /* 0x0400 */
#define CSR_XSTATUS_VS_DIRTY	SHIFT_U32(3, CSR_XSTATUS_VS_BIT)  /* 0x0600 */
