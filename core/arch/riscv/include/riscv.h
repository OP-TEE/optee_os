...
#define XSTATUS_FS_MASK         SSTATUS_FS
...
#define XSTATUS_VS_BIT		9
#define XSTATUS_VS_MASK		SSTATUS_VS
#define XSTATUS_VS_OFF		SHIFT_U32(0, XSTATUS_VS_BIT)
#define XSTATUS_VS_INITIAL	SHIFT_U32(1, XSTATUS_VS_BIT)
#define XSTATUS_VS_CLEAN	SHIFT_U32(2, XSTATUS_VS_BIT)
#define XSTATUS_VS_DIRTY	SHIFT_U32(3, XSTATUS_VS_BIT)
