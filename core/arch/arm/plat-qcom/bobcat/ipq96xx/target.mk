...
# Hardware RNG via the TME-Lite RNG service. The RNG client is built as part
# of the TME-Lite COM stack, so it can only provide hw_get_random_bytes()
# while that stack is enabled.
ifeq ($(CFG_QCOM_TMEL_COM),y)
CFG_HWRNG_PTA ?= y
