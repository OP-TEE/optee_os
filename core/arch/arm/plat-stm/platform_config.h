...
#define CFG_TZDRAM_SIZE		(CFG_DDR_TEETZ_RESERVED_SIZE - \
				CFG_SHMEM_SIZE - \
...
#define TA_RAM_START		CFG_TZDRAM_BASE
#define TA_RAM_SIZE		CFG_TZDRAM_SIZE
...
#define TA_RAM_START		(CFG_TZDRAM_BASE + CFG_TEE_RAM_PH_SIZE)
#define TA_RAM_SIZE		(CFG_TZDRAM_SIZE - CFG_TEE_RAM_PH_SIZE)
