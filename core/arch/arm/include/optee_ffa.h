...
/*
 * Copyright (c) 2019-2025, Linaro Limited
 */
...
#define OPTEE_FFA_YIELDING_CALL_BIT	U(31)
...
#define OPTEE_FFA_YIELDING_CALL_RETURN_DONE		U(0)
#define OPTEE_FFA_YIELDING_CALL_RETURN_RPC_CMD		U(1)
#define OPTEE_FFA_YIELDING_CALL_RETURN_INTERRUPT	U(2)
