...
CFG_SHMEM_START  ?= $(shell echo $$(($(CFG_TZDRAM_START) + 0x1000000)))
CFG_SHMEM_SIZE   ?= 0x400000

CFG_SCMI_SHMEM_START  ?= $(shell echo $$(($(CFG_TZDRAM_START) + 0x1400000)))
CFG_SCMI_SHMEM_SIZE   ?= 0x1000

CFG_TEE_RAM_VA_SIZE ?= 0x100000

# Device tree related configuration
CFG_DT_ADDR ?= $(shell echo $$(($(CFG_TZDRAM_START) + 0x1500000)))
