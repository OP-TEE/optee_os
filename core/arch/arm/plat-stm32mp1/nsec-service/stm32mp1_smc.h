 ...
 * Argument a1: (input) Service ID (STM32_SIP_SVC_BSEC_READ_SHADOW)
 * Argument a2: (input) OTP index
 *		(output) OTP read value
 */
 ...
 * No input or output arguments through CPU general purpose registers.
 */
