 ...
 * Copyright (c) 2025, Conception Ro-Main Inc. All rights reserved.
 *
 * Based on plat-synquacer/rng_pta.c
 * Based on core/pta/hwrng.c
 *
 */
...
#define PTA_NAME "virt-rng.pta"

/* This PTA is used only to emulate hwrng for learning purposes */
static_assert(IS_ENABLED(CFG_WITH_VIRT_RNG));


static TEE_Result virt_get_random_bytes(void *buf, size_t len)
{
    uint8_t *b = buf;
				  ...
				  TEE_Param params[TEE_NUM_PARAMS])
{
	...
	return virt_get_random_bytes(e, params[0].memref.size);
}
