...
#define CFG_TZDRAM_BASE		(TZSRAM_BASE + CFG_TEE_RAM_VA_SIZE)
#define CFG_TZDRAM_SIZE		(0x02000000 - CFG_TEE_RAM_VA_SIZE)

#else /*CFG_WITH_PAGER*/

/* Location of trusted dram on the base fvp */
#define CFG_TZDRAM_BASE		0x06000000
...
#define CFG_TZDRAM_BASE		(TZSRAM_BASE + CFG_TEE_RAM_VA_SIZE)
#define CFG_TZDRAM_SIZE		(0x00E00000 - CFG_TEE_RAM_VA_SIZE)
...
#define CFG_TZDRAM_BASE		(SECRAM_BASE + CFG_TEE_RAM_VA_SIZE)
#define CFG_TZDRAM_SIZE		(SECRAM_SIZE - CFG_TEE_RAM_VA_SIZE)

#else /* CFG_WITH_PAGER */

#define CFG_TZDRAM_BASE		(SECRAM_BASE + SECRAM_COHERENT_SIZE)
#define CFG_TZDRAM_SIZE		(SECRAM_SIZE - SECRAM_COHERENT_SIZE)
...
#define CFG_TZDRAM_BASE		(TZSRAM_BASE + TZSRAM_SIZE)
#define CFG_TZDRAM_SIZE		(SECRAM_SIZE - TZSRAM_SIZE - 0x00100000)

#else /* CFG_WITH_PAGER */

/* First 1MByte of the secure RAM is reserved to ARM-TF runtime services */
#define CFG_TZDRAM_BASE		(SECRAM_BASE + 0x00100000)
#define CFG_TZDRAM_SIZE		(SECRAM_SIZE - 0x00100000)
...
#define TA_RAM_START		ROUNDUP(CFG_TZDRAM_BASE, CORE_MMU_DEVICE_SIZE)
...
#define CFG_TEE_SDP_MEM_BASE		(CFG_TZDRAM_BASE + CFG_TZDRAM_SIZE - \
