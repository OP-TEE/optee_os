 ...
 *  0x0300_0000 [CFG_TZDRAM_BASE, CFG_TEE_LOAD_ADDR] -
 *
 * CFG_WITH_PAGER=y
 *    Unused
 *  0x030A_0000                                  -
 ...
 *  0x0300_0000 [CFG_TZDRAM_BASE, TZSRAM_BASE, CFG_TEE_LOAD_ADDR]
...
#define CFG_TZDRAM_BASE		0x03200000
#define CFG_TZDRAM_SIZE		(14 * 1024 * 1024)

#define CFG_TEE_RAM_START	TZSRAM_BASE
#define CFG_TEE_RAM_PH_SIZE	TZSRAM_SIZE
#define TA_RAM_START		ROUNDUP(CFG_TZDRAM_BASE, CORE_MMU_DEVICE_SIZE)
#define TA_RAM_SIZE		ROUNDDOWN(CFG_TZDRAM_SIZE, CORE_MMU_DEVICE_SIZE)

#else /* CFG_WITH_PAGER */

#define CFG_TZDRAM_BASE		0x03000000
#define CFG_TZDRAM_SIZE		(16 * 1024 * 1024)

#define CFG_TEE_RAM_START	CFG_TZDRAM_BASE
#define CFG_TEE_RAM_PH_SIZE	TEE_RAM_VA_SIZE
