...
/*
 * A single cur_tzasc_region is enough albeit some i.MX6 SoCs are equipped with
 * two TZASCs. The imx_configure_tzasc() is the only function performing the
 * seq. region initialization.
 */
