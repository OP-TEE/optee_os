...
#define BM_CCM_CCGRx_SETTING(idx)	(0x3 << BS_CCM_CCGRx_SETTING(idx))
#define CCM_CCGRx_DISABLE(idx)		(0x0 << BS_CCM_CCGRx_SETTING(idx))
#define CCM_CCGRx_RUN(idx)		(0x1 << BS_CCM_CCGRx_SETTING(idx))
#define CCM_CCGRx_RUN_WAIT(idx)		(0x2 << BS_CCM_CCGRx_SETTING(idx))
#define CCM_CCGRx_ALWAYS_ON(idx)	(0x3 << BS_CCM_CCGRx_SETTING(idx))
