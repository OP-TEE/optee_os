...
CFG_TZDRAM_BASE ?= $(CFG_DDR_TEETZ_RESERVED_START)
...
ifeq ($(filter y, $(CFG_WITH_PAGER)), y)
# emulated SRAM, at start of secure DDR
CFG_CORE_TZSRAM_EMUL_START ?= 0x4E000000
CFG_TZDRAM_BASE ?= 0x4E100000
CFG_TZDRAM_SIZE ?= 0x01E00000
else
CFG_TZDRAM_BASE ?= 0x4E000000
...
CFG_TZDRAM_BASE ?= (DRAM0_BASE + $(CFG_DDR_SIZE) - 0x02000000)
CFG_TZDRAM_SIZE ?= 0x01E00000
endif
...
CFG_SHMEM_START ?= ($(CFG_TZDRAM_BASE) + $(CFG_TZDRAM_SIZE))
