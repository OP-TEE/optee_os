...
#define PIL_ARB_RAW_ADDR			ANTI_ROLLBACK_9_ADDR
...
/* MRC_2_0 region: activation = row 0, revocation = row 1. */
#define MRC_ACTIVATION_LIST_RAW_ADDR		MRC_2_0_ADDR
#define MRC_REVOCATION_LIST_RAW_ADDR		(MRC_2_0_ADDR + 0x8)
