...
{
	io_write32(gcc_base + GCC_Q6SS_TSCTR_1TO2_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_EPCB_RX_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_Q6_AXIM_DIV_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_PCLK_DBG_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_Q6SS_TRIG_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_CXO_CLK_CBCR, CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_ATBM_AT_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_AHBS_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_TURING_GEMNOC_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(gcc_base + GCC_CNOC_TURING_AHBS_CLK_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
}
...
static void cdsp_cc_enable(vaddr_t cc_base, vaddr_t qdsp6ss_base)
{
	...
	io_write32(cc_base + TURING_CC_Q6SS_AHBS_AON_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_CENG_CDSP_AO_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_CENG_AHBS_CBCR, CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_CDSPNOC_AHBS_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_CDSPAUX_XO_CBCR, CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_Q6SS_AHBS_AON_MXC_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_XO_DIV_CBCR, CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_CDSPNOC_APB_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_Q6SS_AHBM_AON_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_ALT_RESET_AON_CBCR,
		   CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_DEBUG_CBCR, CBCR_BRANCH_ENABLE_BIT);
	io_write32(cc_base + TURING_CC_PLL_TEST_CBCR, CBCR_BRANCH_ENABLE_BIT);
	...
	io_write32(qdsp6ss_base + QDSP6SS_DEBUG_CBCR, CBCR_BRANCH_ENABLE_BIT);
