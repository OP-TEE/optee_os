...
struct versal_nvm_read_req {
	...
	struct versal_nvm_buf ibuf[MAX_IPI_BUF];
};
...
static
TEE_Result efuse_write_boot_env(struct versal_efuse_boot_env_ctrl_bits *p)
{
...
static
TEE_Result efuse_read_boot_env_ctrl(struct versal_efuse_boot_env_ctrl_bits *buf)
{
	uint8_t lbuf[1024]__aligned_efuse = { 0 };
	struct versal_nvm_read_req req = {
...
static
TEE_Result efuse_read_puf_sec_ctrl(struct versal_efuse_puf_sec_ctrl_bits *buf)
{
	uint8_t lbuf[1024]__aligned_efuse = { 0 };
	struct versal_nvm_read_req req = {
 ...
 */
static TEE_Result efuse_read_puf_as_user_fuse(struct versal_efuse_puf_user_fuse
					      *p)
{
 ...
 */
static TEE_Result efuse_write_puf_as_user_fuse(struct versal_efuse_puf_user_fuse
					       *p)
{
	uint32_t fuses[PUF_EFUSES_WORDS]__aligned_efuse = { 0 };
	struct versal_efuse_puf_fuse_addr {
...
static struct versal_efuse_write_ops efuse_write_ops = {
	.puf_as_user_fuse = efuse_write_puf_as_user_fuse,
	.offchip_ids = efuse_write_offchip_ids,
	.boot_env_ctrl = efuse_write_boot_env,
	.revoke_ppk = efuse_write_revoke_ppk,
	.glitch_cfg = efuse_write_glitch_cfg,
	.revoke_id = efuse_write_revoke_id,
	.sec_misc1 = efuse_write_sec_misc1,
	.user_data = efuse_write_user_data,
	.dec_only = efuse_write_dec_only,
	.ppk_hash = efuse_write_ppk_hash,
	.aes_keys = efuse_write_aes_keys,
	.misc_ctrl = efuse_write_misc,
	.sec_ctrl = efuse_write_sec,
	.puf = efuse_write_puf,
	.iv = efuse_write_iv,
};
...
static struct versal_efuse_read_ops efuse_read_ops = {
	...
	.puf_as_user_fuse = efuse_read_puf_as_user_fuse,
