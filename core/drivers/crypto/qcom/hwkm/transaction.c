...
static inline void hwkm_pack(uint32_t *reg, uint32_t val, uint32_t mask)
{
...
rollback:
	for (; i > 0; i--) {
		struct hwkm_transaction *t = trans[i - 1];
