...
CFG_QCOM_CE_CIPHER := $(call cfg-one-enabled, \
                          CFG_QCOM_CE_AES_ECB \
                          CFG_QCOM_CE_AES_CBC)
# CFG_QCOM_CE_AUTHENC: GCM enabled -> authenc drvcrypt driver.
CFG_QCOM_CE_AUTHENC := $(call cfg-one-enabled, CFG_QCOM_CE_AES_GCM)
# CFG_QCOM_CE: any algorithm enabled.
CFG_QCOM_CE := $(call cfg-one-enabled, CFG_QCOM_CE_CIPHER CFG_QCOM_CE_AUTHENC)
...
ifeq ($(CFG_QCOM_CE_AUTHENC),y)
$(call force,CFG_CRYPTO_DRV_AUTHENC,y,Mandated by CFG_QCOM_CE_AUTHENC)
endif
