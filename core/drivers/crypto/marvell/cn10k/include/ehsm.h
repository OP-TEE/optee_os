...
/* Number of mailboxes available to eHSM */
...
#define EHSM_MAILBOX1_OFFSET          0x140
...
#define EHSM_CMD_FIFO_STATUS_CORE2_CMD_STATUS_READ_DONE     BIT(7)
#define EHSM_CMD_FIFO_STATUS_CORE1_CMD_STATUS_READ_DONE     BIT(6)
#define EHSM_CMD_FIFO_STATUS_CORE2_CMD_STATUS_BUFFER_FULL   BIT(5)
#define EHSM_CMD_FIFO_STATUS_CORE1_CMD_STATUS_BUFFER_FULL   BIT(4)
	EHSM_CMD_FIFO_STATUS        = (0xc4),

	/* Host interrupt reset register */
	EHSM_CORE1_HOST_INT_RST_REG = (0xc8),
#define EHSM_CMD_CPL_STS_BIT                    BIT(0)
	EHSM_CORE1_HOST_INT_MASK_REG        = (0xcc),
...
#define EHSM_LOADER_FW(X)       ((X) & EHSM_LOADER_FW_MASK)
	...
	/* Request input registers */
	EHSM_CORE2_INPUT_ARG0               = (0x140),
	EHSM_CORE2_INPUT_ARG1               = (0x144),
	EHSM_CORE2_INPUT_ARG2               = (0x148),
	EHSM_CORE2_INPUT_ARG3               = (0x14c),
	EHSM_CORE2_INPUT_ARG4               = (0x150),
	EHSM_CORE2_INPUT_ARG5               = (0x154),
	EHSM_CORE2_INPUT_ARG6               = (0x158),
	EHSM_CORE2_INPUT_ARG7               = (0x15c),
	EHSM_CORE2_INPUT_ARG8               = (0x160),
	EHSM_CORE2_INPUT_ARG9               = (0x164),
	EHSM_CORE2_INPUT_ARG10              = (0x168),
	EHSM_CORE2_INPUT_ARG11              = (0x16c),
	EHSM_CORE2_INPUT_ARG12              = (0x170),
	EHSM_CORE2_INPUT_ARG13              = (0x174),
	EHSM_CORE2_INPUT_ARG14              = (0x178),
	EHSM_CORE2_INPUT_ARG15              = (0x17c),
	EHSM_CORE2_INPUT_CMD                = (0x180),

	/* Request output registers */
	EHSM_CORE2_CMD_RET_STATUS           = (0x1a0),
	EHSM_CORE2_CMD_RET_PARAMETER0       = (0x1a4),
	EHSM_CORE2_CMD_RET_PARAMETER1       = (0x1a8),
	EHSM_CORE2_CMD_RET_PARAMETER2       = (0x1ac),
	EHSM_CORE2_CMD_RET_PARAMETER3       = (0x1b0),
	EHSM_CORE2_CMD_RET_PARAMETER4       = (0x1b4),
	EHSM_CORE2_CMD_RET_PARAMETER5       = (0x1b8),
	EHSM_CORE2_CMD_RET_PARAMETER6       = (0x1bc),
	EHSM_CORE2_CMD_RET_PARAMETER7       = (0x1c0),
	EHSM_CORE2_CMD_RET_PARAMETER8       = (0x1c4),
	EHSM_CORE2_CMD_RET_PARAMETER9       = (0x1c8),
	EHSM_CORE2_CMD_RET_PARAMETER10      = (0x1cc),
	EHSM_CORE2_CMD_RET_PARAMETER11      = (0x1d0),
	EHSM_CORE2_CMD_RET_PARAMETER12      = (0x1d4),
	EHSM_CORE2_CMD_RET_PARAMETER13      = (0x1d8),
	EHSM_CORE2_CMD_RET_PARAMETER14      = (0x1dc),
	EHSM_CORE2_CMD_RET_PARAMETER15      = (0x1e0),

	/* Host interrupt reset register */
	EHSM_CORE2_HOST_INT_RST_REG         = (0x1e4),
	EHSM_CORE2_HOST_INT_MASK_REG        = (0x1e8),
...
enum ehsm_status {
	...
	STATUS_BIU_MAILBOX_OVERRUN                  = 366, //not used by RCASP
...
struct ehsm_command {
	...
	uint32_t ret_status;
	uint32_t ret_parameters[EHSM_NUM_ARGS];
};
...
struct ehsm_handle {
	...
	uintptr_t           mailbox_offset;
	struct ehsm_command *cmd_mailbox;
	uintptr_t           host_int_reg;
	uintptr_t           cmd_ret_status_reg;
	uint32_t            core_cmd_status_read_done_mask;
	uint32_t            core_cmd_buffer_full_mask;
