...
/* Max time to wait for a concurrent HUK fetch to complete */
#define ASU_HUK_FETCH_WAIT_TIMEOUT_US	5000U
...
static TEE_Result asu_fetch_and_cache_huk(void)
{
	...
	uint64_t timeout_ref = timeout_init_us(ASU_HUK_FETCH_WAIT_TIMEOUT_US);
...
TEE_Result tee_otp_get_hw_unique_key(struct tee_hw_unique_key *hwkey)
{
	 ...
	 * This preserves up to 128 bits of entropy in the 16-byte output.
	 */
