...
static const struct syscall_entry tee_syscall_table[] = {
    ...
    SYSCALL_ENTRY(syscall_cryp_psa_obj_generate_key),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_operation_init),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_encrypt_setup),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_decrypt_setup),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_generate_iv),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_set_iv),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_update),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_finish),
    SYSCALL_ENTRY(syscall_cryp_psa_cipher_abort),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_encrypt),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_decrypt),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_operation_init),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_encrypt_setup),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_decrypt_setup),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_generate_nonce),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_set_nonce),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_set_lengths),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_update_ad),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_update),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_finish),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_verify),
    SYSCALL_ENTRY(syscall_cryp_psa_aead_abort),
    SYSCALL_ENTRY(syscall_cryp_psa_sign_message),
    SYSCALL_ENTRY(syscall_cryp_psa_verify_message),
    SYSCALL_ENTRY(syscall_cryp_psa_key_derivation_operation_init),
    SYSCALL_ENTRY(syscall_cryp_psa_key_derivation_setup),
    SYSCALL_ENTRY(syscall_cryp_psa_key_derivation_input_bytes),
    SYSCALL_ENTRY(syscall_cryp_psa_mac_verify),
    SYSCALL_ENTRY(syscall_cryp_psa_mac_compute),
    SYSCALL_ENTRY(syscall_cryp_psa_hash_operation_init),
    SYSCALL_ENTRY(syscall_cryp_psa_hash_compute),
};
